...
export type Actions = 'create' | 'read' | 'update' | 'delete' | 'manage' | 'invite' | 'remove' | 'promote' | 'leave' | 'view' | 'change' | 'add' | 'send' | 'list' | 'comment' | 'attachment' | 'update-basic' | 'update-manage';
